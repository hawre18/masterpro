                            ...
                            @foreach($slides as $slide)
                                <tr>
                                    ...
                                    <td width="35%" class="text-center">
                                        ...
                                        @if($slide->status=='deactive')
                                            <a class="btn btn-success" href="{{route('slides.publish',[$slide->id,$status='active'])}}">منتشر کردن</a>
                                        @else
                                            <a class="btn btn-warning" href="{{route('slides.publish',[$slide->id,$status='deactive'])}}">منقضی </a>
                                        @endif
                                    </td>
                                </tr>
                                @endforeach
